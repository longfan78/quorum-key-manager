...
import (
	...
	"github.com/longfan78/quorum-key-manager/tests/acceptance/docker/config"
	hashConfig "github.com/longfan78/quorum-key-manager/tests/acceptance/docker/config/hashicorp"
	postgresConfig "github.com/longfan78/quorum-key-manager/tests/acceptance/docker/config/postgres"
	hashVault "github.com/longfan78/quorum-key-manager/tests/acceptance/docker/container/hashicorp"
	"github.com/longfan78/quorum-key-manager/tests/acceptance/docker/container/postgres"
	"github.com/longfan78/quorum-key-manager/tests/acceptance/docker/container/reflect"
